                        ...
                        <div class="row no-gutters row-grid">
                            <div class="col-12">
                                <div class="d-flex flex-column align-items-center justify-content-center p-4">
                                    <img src="{{ asset($user->avatar_path) }}" style="max-width: 300px; height: auto" class="rounded-circle shadow-2 img-thumbnail" alt="">
                                    ...
                                    <div class="mt-4 text-center demo">
                                        ...
                                        <a href="{{ $user->telegram }}javascript:void(0);" class="fs-xl" style="color:#0088cc">
